...
function bindProfileListeners() {
  ...
  $('#taste-profile').on('click', function(e) {
    ...
    var name = formData[length-1].value
    var cuisine = cuisineData[name]
    var data = []
    ...
    if ($('#highcharts').length){
      display_taste_profile(data, name, cuisine);
    }
...
var display_taste_profile = function(data, name, cuisine){
